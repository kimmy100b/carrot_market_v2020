	...
	<body>
		<div class="wrapper">
			...
			<div class="container cm-row-contianer">
				<form> <!-- TODO action, method 속성 추가 -->
					<div class="row cm-row">
						<div class="col">
							<span>아이디</span> <span class="cm-necessary-label">*</span>
						</div>
						<div class="cm-col-mid col-6">
							<input type="text" class="form-control" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합" />
						</div>
						<div class="col">
					...
					<div class="row cm-row">
						...
						<div class="cm-col-mid col-6">
							<input type="text" class="form-control" placeholder="예) email@example.com" required />
						</div>
						<div class="col">
					...
					<div class="row cm-row">
						...
						<div class="cm-col-mid col-6">
							<input type="number" class="form-control" placeholder="숫자만 입력해주세요" required />
						</div>
						<div class="col">
					...
					<div class="row cm-row">
						...
						<div class="cm-col-mid col-6">
							<div class="cm-radio-area">
								<div class="custom-control custom-radio custom-control-inline cm-radio">
									<input type="radio" id="customRadioInline1" name="customRadioInline1"
										class="custom-control-input cm-radio-input"> <label
										class="custom-control-label cm-radio-label" for="customRadioInline1">남자</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline cm-radio">
									<input type="radio" id="customRadioInline2" name="customRadioInline1"
										class="custom-control-input cm-radio-input"> <label
										class="custom-control-label cm-radio-label" for="customRadioInline2">여자</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline cm-radio">
									<input type="radio" id="customRadioInline3" name="customRadioInline1"
										class="custom-control-input cm-radio-input"> <label
										class="custom-control-label cm-radio-label" for="customRadioInline3">선택</label>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row cm-row">
						<div class="col text-center cm-sign-up-btn-area">
							<button type="submit" class="col-6 btn cm-sign-up-btn cm-col-mid">회원 가입</button>
						</div>
					</div>
				</form>
			</div>
